...
Route::prefix('admin')->group(function() {
  ...
  Route::get('/appearance/themes', 'Admin\ThemeController@index')->name('admin.appearance.themes');

  //-----------ADMIN Taxes

  Route::get('/accounting/taxes', 'Admin\TaxController@index')->name('admin.accounting.taxes');

  Route::get('/taxes/datatables', 'Admin\TaxController@datatables')->name('admin-tax-datatables');
  Route::get('/taxes/status/{id1}/{id2}', 'Admin\TaxController@status')->name('admin-tax-st');
  Route::get('/taxes/create', 'Admin\TaxController@create')->name('admin-tax-create');
  Route::post('/taxes/create', 'Admin\TaxController@store')->name('admin-tax-store');
  Route::get('/taxes/delete/{id}', 'Admin\TaxController@destroy')->name('admin-tax-delete');
  Route::get('/taxes/edit/{id}', 'Admin\TaxController@edit')->name('admin-tax-edit');
  Route::post('/taxes/edit/{id}', 'Admin\TaxController@update')->name('admin-tax-update');

  Route::get('/appearance/themes/edit/{id}', 'Admin\ThemeController@edit')->name('dmin.appearance.themesedit');
  ...
  Route::get('/orders/datatables/transactions', 'Admin\OrderController@datatables')->name('admin-order-transactiontables'); //JSON REQUEST
  ...
  Route::get('/orders/transactions', 'Admin\OrderController@transactions')->name('admin-order-transactions');
  ...
  //TAX SECTION
//    Route::get('/users/taxes', function () {
...
// Verification Section Ends
 ...
 //------------ ADMIN PRODUCT DISCUSSION SECTION ENDS ------------
  ...
  Route::post('/user/send/message1', 'Admin\MessageController@usercontact1')->name('admin-send-message1');
  ...
  Route::get('/settings/general-settings/logo', 'Admin\GeneralSettingController@logo')->name('admin-gs-logo');
  Route::get('/settings/general-settings/favicon', 'Admin\GeneralSettingController@fav')->name('admin-gs-fav');
  Route::get('/settings/general-settings/loader', 'Admin\GeneralSettingController@load')->name('admin-gs-load');
  Route::get('/settings/general-settings/contents', 'Admin\GeneralSettingController@contents')->name('admin-gs-contents');
  Route::get('/settings/general-settings/footer', 'Admin\GeneralSettingController@footer')->name('admin-gs-footer');
  Route::get('/settings/general-settings/affilate', 'Admin\GeneralSettingController@affilate')->name('admin-gs-affilate');
  Route::get('/settings/general-settings/error-banner', 'Admin\GeneralSettingController@errorbanner')->name('admin-gs-error-banner');
  Route::get('settings/general-settings/popup', 'Admin\GeneralSettingController@popup')->name('admin-gs-popup');
  Route::get('/settings/general-settings/maintenance', 'Admin\GeneralSettingController@maintain')->name('admin-gs-maintenance');
  ...
  Route::get('/settings/page-settings/customize', 'Admin\PageSettingController@customize')->name('admin-ps-customize');
  Route::get('/settings/page-settings/big-save', 'Admin\PageSettingController@big_save')->name('admin-ps-big-save');
  Route::get('/settings/page-settings/best-seller', 'Admin\PageSettingController@best_seller')->name('admin-ps-best-seller');
  ...
  Route::get('/settings/page-settings/contact', 'Admin\PageSettingController@contact')->name('admin-ps-contact');
...
// Payment Informations
  ...
  Route::get('/settings/payment-informations', 'Admin\GeneralSettingController@paymentsinfo')->name('admin-gs-payments');
