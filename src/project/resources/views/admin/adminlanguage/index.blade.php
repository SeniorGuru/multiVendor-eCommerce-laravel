...
@section('settingScript')
    <script>
        $(document).ready(function() {
            ...
            $("#language_settings_a").removeClass("collapsed");
            $("#language_settings_a").attr("aria-expanded", "true");

            $("#language_settings").addClass("show");
            $("#language_settings").attr("aria-expanded", "true");
            $("#language_settings div ul li:nth-child(2)").addClass("active");
        });
    </script>
@endsection
