...
@section('settingScript')
    <script>
        $(document).ready(function() {
            ...
            $("#email_settings_a").removeClass("collapsed");
            $("#email_settings_a").attr("aria-expanded", "true");

            $("#email_settings").addClass("show");
            $("#email_settings").attr("aria-expanded", "true");
            $("#email_settings div ul li:nth-child(2)").addClass("active");
        });
    </script>
@endsection
