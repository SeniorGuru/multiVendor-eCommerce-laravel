							...
							<div class="row">
								<div class="col-lg-12">
										...
										<ul class="links">
											...
											<li>
												<a href="{{ route('admin-currency-index') }}">{{ __('Currency Rates') }}</a>
											</li>
										</ul>
								</div>
							</div>
...
@section('settingScript')
    <script>
        $(document).ready(function() {
            ...
            // $("#payment_settings_a").removeClass("collapsed");
            // $("#payment_settings_a").attr("aria-expanded", "true");
            //
            // $("#payment_settings").addClass("show");
            // $("#payment_settings").attr("aria-expanded", "true");
            // $("#payment_settings div ul li:nth-child(3)").addClass("active");
        });
    </script>
@endsection
