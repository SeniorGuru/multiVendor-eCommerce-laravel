...
@section('settingScript')
    <script>
        $(document).ready(function() {
            ...
            $("#menupage_settings_a").removeClass("collapsed");
            $("#menupage_settings_a").attr("aria-expanded", "true");

            $("#menupage_settings").addClass("show");
            $("#menupage_settings").attr("aria-expanded", "true");
            $("#menupage_settings div ul li:nth-child(1)").addClass("active");
        });
    </script>
@endsection
