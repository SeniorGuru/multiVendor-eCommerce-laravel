...
@section('settingScript')
    <script>
        $(document).ready(function() {
            ...
            $("#socials_settings_a").removeClass("collapsed");
            $("#socials_settings_a").attr("aria-expanded", "true");

            $("#socials_settings").addClass("show");
            $("#socials_settings").attr("aria-expanded", "true");
            $("#socials_settings div ul li:nth-child(1)").addClass("active");
        });
    </script>
@endsection
