...
<head>
        ...
        <link rel="stylesheet" href="{{ asset('assets/admin/css/styles.php?color='.str_replace('#','',$gs->colors).'&amp;'.'header_color='.str_replace('#','',$gs->header_color).'&amp;'.'footer_color='.str_replace('#','',$gs->footer_color).'&amp;'.'copyright_color='.str_replace('#','',$gs->copyright_color).'&amp;'.'menu_color='.str_replace('#','',$gs->menu_color).'&amp;'.'menu_hover_color='.str_replace('#','',$gs->menu_hover_color)) }}">
	...
	<body>
		<div class="page">
			<div class="page-main page-main-admin">
				<!-- Header Menu Area Start -->
                <nav id="sidebar" class="nav-sidebar">
                    <header class="main-header clearfix">
                        <a class="logo"href="{{ route('admin.dashboard') }}">
                            <span class="logo-lg">Multi Vendor</span>
                        </a>

                        <a href="javascript:void(0);" class="sidebar-toggle" data-toggle="offcanvas" role="button" id="sidebarCollapse">
                    ...
                    <ul class="list-unstyled components" id="accordion">
                        ...
                        <li>
                            <a href="{{ route('admin.dashboard') }}" class="wave-effect" id="user_dashboard"><i class="fa fa-dashboard"></i><span>{{ __('Dashboard') }}</span></a>
                        </li>
...
{{--                                        </li>--}}
                                    ...
                                    <div class="menu-toggle-button">
                                        <a class="nav-link" href="javascript:;" id="sidebarCollapses">
