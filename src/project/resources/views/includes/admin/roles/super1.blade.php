<li>
        <a href="#menu2" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="fas fa-tags"></i><span>{{ __('Products') }}</span>
        </a>
...
<li>
        <a href="#order" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false"><i class="fas fa-cart-plus"></i><span>{{ __('Orders') }}</span></a>
    ...
    <li>
        <a href="#menu3" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="icofont-user"></i><span>{{ __('Customers') }}</span>
        </a>
    ...
    <li>
        <a href="#vendor1" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
                <i class="icofont-verification-check"></i><span>{{ __('Vendor Verifications') }}</span>
        </a>
    ...
    <li>
        <a href="{{ route('admin-subscription-index') }}" class=" wave-effect"><i class="fas fa-dollar-sign"></i><span>{{ __('Vendor Subscription Plans') }}</span></a>
    </li>


    <li>
        <a href="#menu5" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false"><i class="fas fa-sitemap"></i><span>{{ __('Manage Categories') }}</span></a>
    ...
    <li>
        <a href="#menu4" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="icofont-speech-comments"></i><span>{{ __('Comments') }}</span>
        </a>
    ...
    <li>
        <a href="{{ route('admin-coupon-index') }}" class=" wave-effect"><i class="fas fa-percentage"></i><span>{{ __('Set Coupons') }}</span></a>
    </li>
    <li>
    ...
    <li>
        <a href="#homepage" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="fas fa-edit"></i><span>{{ __('Home Page Settings') }}</span>
        </a>
    ...
    <li>
        <a href="#menu" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="fas fa-file-code"></i><span>{{ __('Menu Page Settings') }}</span>
        </a>
    ...
    <li>
        <a href="#emails" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="fas fa-at"></i><span>{{ __('Email') }}</span>
        </a>
    ...
    <li>
        <a href="#payments" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="far fa-money-bill-alt"></i><span>{{ __('Payment') }}</span>
        </a>
    ...
    <li>
        <a href="#socials" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="fab fa-facebook-square"></i><span>{{ __('Socials') }}</span>
        </a>
    ...
    <!--</li>-->
    <li>
        <a href="{{ route('admin-staff-index') }}" class=" wave-effect"><i class="fas fa-user-secret"></i><span>{{ __('Manage Staffs') }}</span></a>
    </li>

    <li>
        <a href="{{ route('admin-subs-index') }}" class=" wave-effect"><i class="fas fa-users-cog mr-2"></i><span>{{ __('Subscribers') }}</span></a>
    </li>

        <li>
            <a href="{{ route('admin-role-index') }}" class=" wave-effect"><i class="fas fa-user-tag"></i><span>{{ __('Manage Roles') }}</span></a>
        </li>
        <li>
        <a href="{{ route('admin-cache-clear') }}" class=" wave-effect"><i class="fas fa-sync"></i><span>{{ __('Clear Cache') }}</span></a>
        </li>
        <!--<li>-->
